...
export const metadata: Metadata = {
  title: "About PouchCompare",
  description: "Learn what PouchCompare is building and why independent nicotine pouch reviews matter.",
  alternates: {
    canonical: "/about",
  },
};
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <section className="rounded-xl border border-white/8 bg-card p-6 sm:p-8">
        <p className="mb-3 text-sm uppercase tracking-[0.16em] text-accent">About PouchCompare</p>
        ...
        <p className="max-w-3xl leading-relaxed text-white/50">
          PouchCompare is building an honest, user-driven reference for nicotine pouches. We compare brands,
